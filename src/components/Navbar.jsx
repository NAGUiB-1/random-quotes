...
let style = "group-hover:text-blue-500 transition-all";
const Navbar = () => {
  ...
  return (
    <div className=" py-4 fixed bottom-0 md:top-0 left-0 bg-black bg-opacity-60  h-fit z-30 w-screen">
      <div className="container mx-auto flex items-center justify-between gap-8">
        <h3 className="text-4xl select-none cursor-pointer hover:text-blue-500 hover:font-black transition-all">
          Quotes
        </h3>
        <div className="flex gap-8">
          ...
          <NavLink
            className={({ isActive }) =>
              isActive ? "text-blue-500 group" : "group"
            }
            to={"/"}
          >
            <ImQuotesLeft size={40} className={style} />
          </NavLink>
          {/*================== Link To saved-quotes Page ================ */}
          <NavLink
            className={({ isActive }) =>
              isActive ? "text-blue-500 relative group" : "relative group"
            }
            to={"/saved-quotes"}
          >
            <IoBookmarks size={40} className={style} />
